                                    ...
                                    <tbody>
                                        {
                                            filterarr.map((movieObj) => (
                                                <tr>
                                                    ...
                                                    <td><img src={`https://image.tmdb.org/t/p/original${movieObj.backdrop_path}`} alt={movieObj.title} style={{ width: '5rem' }}></img>{movieObj.title}</td>
